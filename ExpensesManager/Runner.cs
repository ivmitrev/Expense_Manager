...
public class Runner
{
    ...
    private bool balanceAndAddMenu;
    private bool expenseAndRemoveMenu;

    public Runner(string path, double balance, double totalSpent, bool mainMenu, bool balanceAndAddMenu,
        bool expenseAndRemoveMenu)
    {
        this.path = path;
        this.balance = balance;
        this.totalSpent = totalSpent;
        this.mainMenu = mainMenu;
        this.balanceAndAddMenu = balanceAndAddMenu;
        this.expenseAndRemoveMenu = expenseAndRemoveMenu;
    }
    ...
    private int WriteValidInputForMenus()
    {
        while (true)
        {
    ...
    private void BalanceAndAddMenu()
    {
        while (true)
        {
            Console.Clear();
    ...
    private void ExpenseAndRemoveMenu()
    {
        while (true)
        {
            Console.Clear();
